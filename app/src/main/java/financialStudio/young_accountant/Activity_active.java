...
public class Activity_active extends BaseActivite {
    ...
    private void init_active1(){
        ...
        sch = new SchetAdapter(getApplicationContext(), getIntent().getStringArrayListExtra("active_1"));
        listView.setAdapter(sch);
    }
    ...
    private void init_active2(){
        ...
        sch = new SchetAdapter(getApplicationContext(), getIntent().getStringArrayListExtra("active_2"));
        listView.setAdapter(sch);
    }
